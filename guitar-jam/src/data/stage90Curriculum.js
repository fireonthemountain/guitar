...
export const STAGE90_WEEKS = [
  ...
  },
  {
    ...
    lesson: {
      p: [
        ...
        'Once chosen, add them to My Set in the Songbook tab with a target tempo. Song 1 — the easiest — starts work immediately. A good-enough set practiced for eleven weeks beats a perfect set postponed.',
      ],
      tabs: [REFERENCE_TAB],
      terms: [
  ...
  },
  {
    ...
    days: [
      ...
      { f: 'The volume ladder', h: ['On one chord, pattern 2: 4 bars soft → 4 medium → 4 loud → back down. Twice.', 'Play the verse soft and the chorus loud, 60% tempo.', 'Notice: loud comes from arm speed, not a death grip.'] },
  ...
  },
  {
    ...
    days: [
      ...
      { f: 'Dynamics pass', h: ['Full song at 70%: verses soft, chorus loud, on purpose.', 'Trouble bars: 5 reps each, now with the dynamic they\'ll wear in the song.', 'One relaxed 12-bar blues to close.'] },
  ...
  },
  {
    ...
    days: [
      ...
      { f: 'Jam Along #1', h: ['Twenty minutes over the 12-bar blues vamp (or a Jam Along video): comp chords, keep the groove, no stopping.', 'Deliberately flub once per chorus and play through it.', 'One memory run of song 1\'s verse + chorus.'] },
  ...
  },
  {
    ...
    days: [
      ...
      { f: 'Song 2 at 70', h: ['Song 2 full form with sheet at 70%, twice.', 'The seam drill: song 2\'s verse→chorus transition 10×.', 'Song 1 stays warm: verse + chorus, standing, memory.'] },
  ...
  },
  {
    ...
    days: [
      ...
      { f: 'Flub day', h: ['Both songs, one run each with two planted flubs — recovery within a bar.', 'Then one honest run each, no plants; play through whatever real flubs come.', '12-bar blues, two relaxed rounds.'] },
  ...
  },
  {
    ...
    days: [
      ...
      { f: 'Flub drill, three songs', h: ['One planted-flub run per song (sheet OK for song 3).', 'Recovery within 4 beats, face neutral — that\'s the rep that counts.', 'Decision check: is song 3 the right reach? Commit or swap today.'] },
  ...
  },
  {
    ...
    days: [
      ...
      { f: 'Timed and talked', h: ['Script one or two sentences per gap: a title, a thank-you. Write them down.', 'Full set run, saying the lines out loud, even alone. Yes, it\'s awkward. Twice is less awkward.', 'Log time + stumbles in the Set Runner.'] },
